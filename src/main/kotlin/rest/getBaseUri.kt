...
fun getBaseUri(headers: HttpHeaders, uri: URI, id: BestellungId? = null): String {
    ...
    if (envoyOriginalPath != null) {
        ...
        // x-envoy-decorator-operation: "bestellung.acme.svc.cluster.local:8080/bestellungen/*",
        // x-envoy-original-path: "/bestellungen/api/00000000-0000-0000-0000-000000000001"
    ...
    if (forwardedHost != null) {
        ...
        // x-forwarded-prefix: "/bestellungen"
        val forwardedProto = headers.getFirst("x-forwarded-proto")
