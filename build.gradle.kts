...
dependencies {
    ...
    // fuer PostgreSQL-Treiber und SCRAM zur Authentifizierung
...
sweeney {
    // TODO Java 18 ab 7.5 RC1 https://github.com/gradle/gradle/issues/19283
    enforce(mapOf("type" to "gradle", "expect" to "[7.4,7.4]"))
    // https://devcenter.heroku.com/articles/java-support#specifying-a-java-version
    enforce(mapOf("type" to "jdk", "expect" to "[17.0.2,18]"))
    validate()
}
